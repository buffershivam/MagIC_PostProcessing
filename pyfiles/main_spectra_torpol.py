...
if __name__=="__main__":
    ...
    print("started")
    E_p_l,E_t_l,E_p_m,E_t_m=leg._spectra_poloidal_toroidal(radius,poloidal,toroidal)
    data=np.column_stack((E_p_l,E_t_l,E_p_m,E_t_m))
    #Eltot_avg,Elphi_avg,Elthe_avg,Elrad_avg=leg._spectra_zonal(radius,poloidal,toroidal)
    ...
    np.savetxt("Ra6_torpol.dat",data)
    print("stopped")
